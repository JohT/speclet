...
class ArrayTreePer {                   
 public:
  ...
  real_DWT *block_start(const integer &L, const integer &B) const;      
       // pointer to the start of block B at level L

  integer block_length(const integer &L) const;      
       // block length at level L

  real_DWT *left_child(const integer &L, const integer &B) const; 
       // pointer to begining of left child of block B at level L

  real_DWT *right_child(const integer &L, const integer &B) const; 
  ...
  real_DWT *origin;           // pointer to begining of data array
};
