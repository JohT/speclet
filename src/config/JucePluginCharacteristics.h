...
#if NDEBUG
#define JucePlugin_Name                 "Speclet (built 11.6.)"
#else
#define JucePlugin_Name                 "Speclet (built 11.6. debug)"
#endif
#define JucePlugin_Desc                 "Spectrum Analyzer"
#define JucePlugin_Manufacturer         "Johannes Troppacher"
#define JucePlugin_ManufacturerCode     'TroJ'
#define JucePlugin_PluginCode           'SpcJ'
...
#define JucePlugin_VersionCode          0x09000
...
#define JucePlugin_AUExportPrefixQuoted "SpecletAU"
